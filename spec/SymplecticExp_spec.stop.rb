...
#
# Time-stamp: <2014-08-05 11:02:48 (ryosuke)>
#
require('spec_helper')
...
describe SympMagnusExp do
  ...
  describe "when initialized" do
    it { expect( Theta_symp.mod_deg).to eq 2 }
  end
  #---------------------------------
...
#       it { is_expected.to eq '1+b+ab-ba-aba+baa'}
#     end
#     #
...
#       it { is_expected.to eq '1+a+ab-ba-bab+bba'}
#     end
#     #
...
#         it { expect( Theta_symp.expand(Word.new(str)).show).to eq '(1)1' }
#       end
#     end
#     #
   end
